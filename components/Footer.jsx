    ...
    <footer className={styles.footer}>
      <div className="contenedor">
        <div className={styles.grid}>
          <div>
            ...
            <div className={styles.redes}>
              <a href="#" aria-label="Facebook de Francés">
              ...
              <a href="#" aria-label="Instagram de Francés">
                <svg viewBox="0 0 24 24" aria-hidden="true">
              ...
              <a
                ...
                target="_blank"
                rel="noopener"
                aria-label="WhatsApp de Francés"
              >
                <svg viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div>
            ...
            <ul>
              ...
              <li>
                <Link href="/productos#calcetin-nino">Calcetín niño</Link>
              </li>
              <li>
                <Link href="/productos#tin-dama">Tin Dama</Link>
              </li>
              <li>
                <Link href="/productos#escolar-nina">Calceta escolar niña</Link>
              </li>
              <li>
                <Link href="/productos#diabetico-dama">Línea diabético dama</Link>
              </li>
              <li>
                <Link href="/productos#diabetico-caballero">Línea diabético caballero</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul>
              ...
              <li>
                <a href="mailto:ventas@calcetasfrances.com">
                  ventas@calcetasfrances.com
                </a>
              </li>
        ...
        <div className={styles.legal}>
          <span>
            &copy; <span>{anio}</span> Francés. Calcetas y calcetines
            hechos en México.
          </span>
