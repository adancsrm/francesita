...
/**
 * Francesita — envío de correo (equivalente en Node de php/lib/mailer.php).
...
export async function enviarCorreo(destinatario, asunto, cuerpoHtml, responderA = "", nombreResponderA = "") {
  const remitente = process.env.CORREO_REMITENTE || "no-reply@francesitas.com.mx";
  const nombreRemitente = process.env.NOMBRE_REMITENTE || "Sitio web Francesita";
